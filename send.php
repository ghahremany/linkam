...
<title>ارسال لینک به لینکفا</title>
<link rel="stylesheet" href="<?php echo theme_dir(); ?>style.css" type="text/css" />
<style>body{direction:rtl}#page{padding:5px;margin:5px auto;width:360px !important;min-width: 0px !important;}input[type=submit]{font-family: tahoma;font-size: 12px;}input[type=text]{font-family: tahoma;font-size: 13px;width:50%;}</style>
</head>

<body>
<div id="page">
	<div class="date"><img src="<?php echo theme_dir(); ?>/img/rss.png"><p>ارسال لینک به لینکفا</p></div>
